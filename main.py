...
account_path,card_path,client_path,disp_path,district_path,loan_path,order_path,trans_path,visual_columns,countplot_columns,eda_path_seaborn,eda_path_sweetviz,feature_cols,cols_to_be_dropped,model_path = configure()
...
## Model Training and Evaluation Metrics along with pickalizing the model

final_model(model_path,X_train,X_test,y_train,y_test)
